...
function run_setup()
{
    ...
    wget -nv -P $INSTALL_DIR https://repo.continuum.io/miniconda/Miniconda2-4.3.31-Linux-x86_64.sh || return 1
    bash $INSTALL_DIR/Miniconda2-4.3.31-Linux-x86_64.sh -b -s -p $INSTALL_DIR/miniconda || return 1
